...
declare function deleteTag(tag: TagEntity): Promise<TagEntity['id']>;
declare function deleteAllTags(ids: Array<TagEntity['id']>): Promise<Array<TagEntity['id']>>;
declare function updateTag(tag: TagEntity): Promise<TagEntity>;
declare function findTags(): Promise<TagEntity[]>;
export {};
